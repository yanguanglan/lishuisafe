...
<div class="block">
  ...
  <span>
	...
	<div class="cont jdtj white">
      ...
      <tr class="top">
                        <td height="65" align="center" bgcolor="#efefef">排名</td>
                        <td height="65" align="center" bgcolor="#efefef">区域</td>
                        ...
                        <td height="65" align="center"  bgcolor="#efefef">不合格清单 </td>
                    </tr>
                  <?php
                  $i = 0;
                  ?>
                  ...
                  ?>
                    <tr>
                        ...
                        <td height="39" align="center"  >{{$value->cityName}}</td>
