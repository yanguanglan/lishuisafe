	...
	<div class="cont jdtj white">
		<table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#e3e3e3">
                    <tr class="top">
                        ...
                        <td height="65" bgcolor="#efefef">行业</td>
                    ...
                    <tr>
                        ...
                        <td height="39" ><a href="{{ URL::route('jdjcsh', array('institutionID'=> $value->institutionID, 'res'=>2, 'startDate'=>$startDate, 'endTime'=>$endTime, 'usertype'=>$usertype, 'city'=>$city)) }}">{{$value->totalNum }}</a></td>
                        <td height="39" ><a href="{{ URL::route('jdjcsh', array('institutionID'=> $value->institutionID, 'res'=>1, 'startDate'=>$startDate, 'endTime'=>$endTime, 'usertype'=>$usertype, 'city'=>$city)) }}">{{$value->qualifiedNum }}</a></td>
                        <td height="39" ><a href="{{ URL::route('jdjcsh', array('institutionID'=> $value->institutionID, 'res'=>0, 'startDate'=>$startDate, 'endTime'=>$endTime, 'usertype'=>$usertype, 'city'=>$city)) }}">{{$value->noQualifiedNum }}</a></td>
                    </tr>
                    @endforeach
                </table>
	</div>
