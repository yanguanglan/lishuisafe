...
function change(v){
   ...
   with(ss){
       ...
       if(++v<s.length){
           change(v);}}}
var dsy=new Dsy();
dsy.add("0",["上海","北京","福建","天津","广东","浙江","贵州","海南","河北","河南","黑龙江","湖北","湖南","吉林","江苏","江西","辽宁","内蒙古","宁夏","青海","山东","山西","陕西","安徽","四川","甘肃","西藏","新疆","云南","广西","重庆"]);
dsy.add("0_23",["安庆","蚌埠","巢湖","池州","滁州","阜阳","合肥","淮北","淮南","黄山","六安","马鞍山","宿州","铜陵","芜湖","宣城","亳州"]);
dsy.add("0_23_0",["安庆市","怀宁县","潜山县","宿松县","太湖县","桐城市","望江县","岳西县","枞阳县"]);
dsy.add("0_23_1",["蚌埠市","固镇县","怀远县","五河县"]);
dsy.add("0_23_2",["巢湖市","含山县","和县","庐江县","无为县"]);
dsy.add("0_23_3",["池州市","东至县","青阳县","石台县"]);
dsy.add("0_23_4",["滁州市","定远县","凤阳县","来安县","明光市","全椒县","天长市"]);
dsy.add("0_23_5",["阜南县","阜阳市","界首市","临泉县","太和县","颖上县"]);
dsy.add("0_23_6",["长丰县","肥东县","肥西县"]);
dsy.add("0_23_7",["淮北市","濉溪县"]);
dsy.add("0_23_8",["凤台县","淮南市"]);
dsy.add("0_23_9",["黄山市","祁门县","休宁县","歙县","黟县"]);
dsy.add("0_23_10",["霍邱县","霍山县","金寨县","六安市","寿县","舒城县"]);
dsy.add("0_23_11",["当涂县","马鞍山市"]);
dsy.add("0_23_12",["灵璧县","宿州市","萧县","泗县","砀山县"]);
dsy.add("0_23_13",["铜陵市","铜陵县"]);
dsy.add("0_23_14",["繁昌县","南陵县","芜湖市","芜湖县"]);
dsy.add("0_23_15",["广德县","绩溪县","郎溪县","宁国市","宣城市","泾县","旌德县"]);
dsy.add("0_23_16",["利辛县","蒙城县","涡阳县","亳州市"]);
dsy.add("0_1",["北京"]);
dsy.add("0_1_0",["北京市","密云县","延庆县"]);
dsy.add("0_2",["福州","莆田","泉州","厦门","龙岩","南平","三明","宁德","漳州"]);
dsy.add("0_2_0",["长乐市","福清市","福州市","连江县","罗源县","闽侯县","闽清县","平潭县","永泰县"]);
dsy.add("0_2_4",["长汀县","连城县","龙岩市","上杭县","武平县","永定县","漳平市"]);
dsy.add("0_2_5",["光泽县","建阳市","建瓯市","南平市","浦城县","邵武市","顺昌县","松溪县","武夷山市","政和县"]);
dsy.add("0_2_7",["福安市","福鼎市","古田县","宁德市","屏南县","寿宁县","霞浦县","周宁县","柘荣县"]);
dsy.add("0_2_1",["莆田市","仙游县"]);
dsy.add("0_2_2",["安溪县","德化县","惠安县","金门县","晋江市","南安市","泉州市","石狮市","永春县"]);
dsy.add("0_2_6",["大田县","建宁县","将乐县","明溪县","宁化县","清流县","三明市","沙县","泰宁县","永安市","尤溪县"]);
dsy.add("0_2_3",["厦门市"]);
dsy.add("0_2_8",["长泰县","东山县","华安县","龙海市","南靖县","平和县","云霄县","漳浦县","漳州市","诏安县"]);
dsy.add("0_25",["白银","定西","甘南藏族自治州","嘉峪关","金昌","酒泉","兰州","临夏回族自治州","陇南","平凉","庆阳","天水","武威","张掖"]);
dsy.add("0_25_0",["白银市","会宁县","景泰县","靖远县"]);
dsy.add("0_25_1",["定西县","临洮县","陇西县","通渭县","渭源县","漳县","岷县"]);
dsy.add("0_25_2",["迭部县","合作市","临潭县","碌曲县","玛曲县","夏河县","舟曲县","卓尼县"]);
dsy.add("0_25_3",["嘉峪关市"]);
dsy.add("0_25_4",["金昌市","永昌县"]);
dsy.add("0_25_5",["阿克塞哈萨克族自治县","安西县","敦煌市","金塔县","酒泉市","肃北蒙古族自治县","玉门市"]);
dsy.add("0_25_6",["皋兰县","兰州市","永登县","榆中县"]);
dsy.add("0_25_7",["东乡族自治县","广河县","和政县","积石山保安族东乡族撒拉族自治县","康乐县","临夏市","临夏县","永靖县"]);
dsy.add("0_25_8",["成县","徽县","康县","礼县","两当县","文县","武都县","西和县","宕昌县"]);
dsy.add("0_25_9",["崇信县","华亭县","静宁县","灵台县","平凉市","庄浪县","泾川县"]);
dsy.add("0_25_10",["合水县","华池县","环县","宁县","庆城县","庆阳市","镇原县","正宁县"]);
dsy.add("0_25_11",["甘谷县","秦安县","清水县","天水市","武山县","张家川回族自治县"]);
dsy.add("0_25_12",["古浪县","民勤县","天祝藏族自治县","武威市"]);
dsy.add("0_25_13",["高台县","临泽县","民乐县","山丹县","肃南裕固族自治县","张掖市"]);
dsy.add("0_4",["深圳","东莞","汕头","广州","中山","珠海","佛山","揭阳","茂名","梅州","清远","江门","汕尾","韶关","惠州","阳江","云浮","湛江","肇庆","河源","潮州"]);
dsy.add("0_4_20",["潮安县","潮州市","饶平县"]);
dsy.add("0_4_1",["东莞市"]);
dsy.add("0_4_6",["佛山市","顺德区"]);
dsy.add("0_4_3",["广州市","从化市","增城市"]);
dsy.add("0_4_19",["东源县","和平县","河源市","连平县","龙川县","紫金县"]);
dsy.add("0_4_14",["博罗县","惠东县","惠阳市","惠州市","龙门县"]);
dsy.add("0_4_11",["恩平市","鹤山市","江门市","开平市","台山市"]);
...
dsy.add("0_4_4",["中山市"]);
dsy.add("0_4_5",["珠海市"]);
dsy.add("0_29",["百色","北海","崇左","防城港","桂林","贵港","河池","贺州","来宾","柳州","南宁","钦州","梧州","玉林"]);
dsy.add("0_29_0",["百色市","德保县","靖西县","乐业县","凌云县","隆林各族自治县","那坡县","平果县","田东县","田林县","田阳县","西林县"]);
dsy.add("0_29_1",["北海市","合浦县"]);
dsy.add("0_29_2",["崇左市","大新县","扶绥县","龙州县","宁明县","凭祥市","天等县"]);
dsy.add("0_29_3",["东兴市","防城港市","上思县"]);
dsy.add("0_29_4",["恭城瑶族自治县","灌阳县","桂林市","荔浦县","临桂县","灵川县","龙胜各族自治县","平乐县","全州县","兴安县","阳朔县","永福县","资源县"]);
dsy.add("0_29_5",["桂平市","贵港市","平南县"]);
dsy.add("0_29_6",["巴马瑶族自治县","大化瑶族自治县","东兰县","都安瑶族自治县","凤山县","河池市","环江毛南族自治县","罗城仡佬族自治县","南丹县","天峨县","宜州市"]);
dsy.add("0_29_7",["富川瑶族自治县","贺州市","昭平县","钟山县"]);
dsy.add("0_29_8",["合山市","金秀瑶族自治县","来宾市","武宣县","象州县","忻城县"]);
dsy.add("0_29_9",["柳城县","柳江县","柳州市","鹿寨县","融安县","融水苗族自治县","三江侗族自治县"]);
dsy.add("0_29_10",["宾阳县","横县","隆安县","马山县","南宁市","上林县","武鸣县","邕宁县"]);
dsy.add("0_29_11",["灵山县","浦北县","钦州市"]);
dsy.add("0_29_12",["苍梧县","蒙山县","藤县","梧州市","岑溪市"]);
dsy.add("0_29_13",["北流市","博白县","陆川县","容县","兴业县","玉林市"]);
...
dsy.add("0_5",["丽水","杭州","宁波","温州","绍兴","湖州","嘉兴","金华","衢州","舟山","台州"]);
dsy.add("0_5_0",["丽水市","莲都区","龙泉市","青田县","缙云县","遂昌县","松阳县","云和县","庆元县","景宁畲族自治县"]);
dsy.add("0_5_1",["杭州市","上城区","下城区","江干区","拱墅区","西湖区","滨江区","余杭区","萧山区","建德市","富阳市","临安市","桐庐县","淳安县"]);
dsy.add("0_5_2",["宁波市","海曙区","江东区","江北区","北仑区","镇海区","鄞州区","余姚市","慈溪市","奉化市","象山县","宁海县"]);
dsy.add("0_5_3",["温州市","鹿城区","龙湾区","瓯海区","瑞安市","乐清市","洞头县","永嘉县","平阳县","苍南县","文成县","泰顺县"]);
dsy.add("0_5_4",["绍兴市","越城区","柯桥区","上虞区","诸暨市","嵊州市","新昌县"]);
dsy.add("0_5_5",["湖州市","吴兴区","南浔区","德清县","长兴县","安吉县"]);
dsy.add("0_5_6",["嘉兴市","南湖区","秀洲区","海宁市","平湖市","桐乡市","嘉善县","海盐县"]);
dsy.add("0_5_7",["金华市","婺城区","金东区","兰溪市","东阳市","永康市","义乌市","武义县","浦江县","磐安县"]);
dsy.add("0_5_8",["衢州市","柯城区","衢江区","江山市","常山县","开化县","龙游县"]);
dsy.add("0_5_9",["舟山市","定海区","普陀区","岱山县","嵊泗县"]);
dsy.add("0_5_10",["台州市","椒江区","黄岩区","路桥区","温岭市","临海市","三门县","天台县","仙居县","玉环县"]);
dsy.add("0_30",["重庆"]);
